...
val dist:RDD[(Long, Long, Double)] = model.map(x => (x._1, x._2._1, (x._2._2 - point._2._1) * (x._2._2 - point._2._1) + (x._2._3 - point._2._2) * (x._2._3 - point._2._2))).filter(x => x._3 <= eps_squared && x.srcId!=x.dstId);  
